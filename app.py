...
def create_sankey(phi, alpha, beta):
    ...
    fig = go.Figure(go.Sankey(
        node=dict(
            pad=20, thickness=25,
            label=labels,
            x=[0.1, 0.1, 0.4, 0.4, 0.8, 0.8],  # Spread out the nodes
            y=[0.2, 0.8, 0, 0.4, 0.6, 1],      # Adjust vertical positioning
...
When you are looking at an awesome result and wondering if this is real life, you are wondering about FDR, and not about the FPR, only when you are very diligent on what you test on and the power of the XP does FPR approximate FDR.
